...
<jsp:useBean id="sampleHelloWorldProxyid" scope="session" class="com.example.webservice.HelloWorldProxy" />
<%
...
case 10:
        gotMethod = true;
        com.example.webservice.HelloWorld getHelloWorld10mtemp = sampleHelloWorldProxyid.getHelloWorld();
...
case 13:
        ...
        java.lang.String helloWorld13mtemp = sampleHelloWorldProxyid.helloWorld(name_1idTemp);
