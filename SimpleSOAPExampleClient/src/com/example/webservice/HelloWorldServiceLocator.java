...
public class HelloWorldServiceLocator extends org.apache.axis.client.Service implements com.example.webservice.HelloWorldService {
    ...
    public com.example.webservice.HelloWorld getHelloWorld() throws javax.xml.rpc.ServiceException {
    ...
    public com.example.webservice.HelloWorld getHelloWorld(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.example.webservice.HelloWorldSoapBindingStub _stub = new com.example.webservice.HelloWorldSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.example.webservice.HelloWorld.class.isAssignableFrom(serviceEndpointInterface)) {
                com.example.webservice.HelloWorldSoapBindingStub _stub = new com.example.webservice.HelloWorldSoapBindingStub(new java.net.URL(HelloWorld_address), this);
                _stub.setPortName(getHelloWorldWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://webservice.example.com", "HelloWorldService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://webservice.example.com", "HelloWorld"));
        }
